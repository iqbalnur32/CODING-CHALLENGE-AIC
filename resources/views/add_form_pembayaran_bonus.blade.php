        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" id="totalBonus" class="form-control">
            </div>
            <div id="buruhInput">
              <div class="form-group">
                <label for="">Buruh 1</label>
                <div class="input-group mb-3">
                  <input type="number" class="form-control percentage" id="percentage_1" required>
              ...
              <div class="form-group">
                <label for="">Buruh 2</label>
                <div class="input-group mb-3">
                  <input type="number" class="form-control percentage" id="percentage_2" required>
                  <div class="input-group-append">
                    <span class="input-group-text" id="basic-addon2">%</span>
                    <button type="button"class="btn btn-danger delete-field">Delete</button>
                  </div>
              ...
              <div class="form-group">
                <label for="">Buruh 3</label>
                <div class="input-group mb-3">
                  <input type="number" class="form-control percentage" id="percentage_3" required>
                  <div class="input-group-append">
                    <span class="input-group-text" id="basic-addon2">%</span>
                    <button type="button"class="btn btn-danger delete-field">Delete</button>
                  </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on('input', '.percentage', function() {
      calculateBonus(); // Calculate bonus when percentage input changes
    });
